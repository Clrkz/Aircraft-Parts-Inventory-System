var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="logo1.png" height="100px" width="100px" style="position: absolute;top:0;left:10px;"><center><h4 style="margin-top:-40px;">ROYAL STAR AVIATION MAINTENANCE AND SERVICES, INC.</h4>\
							<h5>RSA Hangar, Manila Domestic Airport</h5>\
							<h5>Andrews Avenue, Pasay City</h5>\
							</center>',
							...
							dom: "Bfrtip",
									buttons: [
										...
										},
										{
											...
											message: '<center><h4>ROYAL STAR AVIATION MAINTENANCE AND SERVICES, INC.</h4>\
														<h5>RSA Hangar, Manila Domestic Airport</h5>\
														<h5>Andrews Avenue, Pasay City</h5>\
														</center>',
											customize: function ( win ) {
