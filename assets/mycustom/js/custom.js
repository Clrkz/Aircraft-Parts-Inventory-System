...
.done(function(data){
   ...
   if(data != 0 ){
        ...
        $('select[name="e_assigned"]').html('<option disabled selected>Please select assign location</option>');
   }
})
.fail(function(data){
    console.log(data);
...
.done(function(data){
    ...
    $('select[name="reserve_room"]').html('<option selected>Please Select Location</option>'+b);
